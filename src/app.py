...
dfPrinc = pd.read_csv('../dados/processado/dfPrincipal.csv')
dfEvasoes = pd.read_csv('../dados/processado/evasoesDF.csv')
dfGenero = pd.read_csv('../dados/processado/generoDF.csv')
dfIdade = pd.read_csv('../dados/processado/idadeDF.csv')
