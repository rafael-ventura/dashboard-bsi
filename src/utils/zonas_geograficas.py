# Correções específicas para bairros e cidades
correcoes_bairros = {
    ...
    'brás de pina': ['brás de pina', 'bras de pina', 'braz de pina'],
    'cachambi': ['cachambí'],
    'coelho neto': ['coelho'],
    'colégio': ['colegio'],
    'cosme velho': ['cosme velh'],
    'freguesia': ['freguesia (jacarepagua)', 'freguesia-jacarepagua', 'freguesia', 'freguesia/jacarepaguá',
                  'freguesia  jacarepaguá'],
    'gardênia azul': ['gardenia azul'],
    'grajaú': ['graiau', 'grajau'],
    'higienopolis': ['higianopolis'],
    'humaitá': ['humaita'],
    'inhaúma': ['inhaaoma', 'InhaÃºma', 'inhauma'],
    'iraja': ['iraja!'],
    'itapeba': ['itopeba'],
    'jacaré': ['jacare'],
    ...
    'jardim guanabara': ['jardim guanabara/ilha do governador', 'jardim guanabara / ilha do governador'],
    ...
    'praça seca': ['praassa seca', 'praÃ§a Seca', 'praca seca'],
    'praça da bandeira': ['praassa da bandeira', 'praassa da bandeira', 'pca da bandeira', 'praca da bandeira', 'praÃ§a da bandeira'],
...
correcoes_cidades = {
    'RIO DE JANEIRO': ['RIO DE JANEIRO', 'RIO DE JANERO', 'RIO D JANEIRO'],
    'NITERÓI': ['NITEROI', 'NITERÓI'],
    'MARICÁ': ['MARICA', 'MARICÁ'],
    'VITÓRIA': ['VITORIA', 'VITÓRIA'],
    'BELO HORIZONTE': ['BELO HORIZONTE', 'BELO HORIZONTE MG'],
...
bairros_centro = ['Gamboa', 'Centro do Rio', 'Centro', 'Lapa', 'Saúde', 'Cidade Nova', 'Santa Teresa', 'Estácio',
                  'Catumbi', 'Santo Cristo', 'Paquetá', 'Glória']
